// market-data.js – Reads static JSON, uses history if available, else accumulates
const MarketData = {
    ...
    async fetch(symbol) {
        ...
        try {
            ...
            // If the API returned a full history array (e.g., crypto), use it immediately
    ...
    async fetchDXY() {
        try {
            ...
            // DXY file contains currentPrice and history (from Twelve Data)
            return { dxyPrice: data.currentPrice, dxyTrend: 'NEUTRAL', dxyStrength: 'NEUTRAL' };
        } catch(e) {
